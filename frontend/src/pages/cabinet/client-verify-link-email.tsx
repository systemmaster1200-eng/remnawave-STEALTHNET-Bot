...
export function ClientVerifyLinkEmailPage() {
  ...
  }, [token, verifyLinkEmail, navigate]);
      ...
      >
        ...
        <Card className="border shadow-lg">
          <CardHeader>
            ...
            <CardTitle className="text-center">Привязка почты</CardTitle>
          </CardHeader>
          <CardContent className="text-center">
            ...
            {status === "ok" && (
              <p className="text-green-600">Почта привязана. Перенаправление в профиль…</p>
            )}
            {status === "error" && (
